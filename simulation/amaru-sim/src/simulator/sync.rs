...
use amaru_kernel::{self, Point, peer::Peer};
use amaru_slot_arithmetic::Slot;
use futures_util::sink::SinkExt;
use gasket::framework::*;
use serde::{Deserialize, Serialize};
use std::fmt;
use tokio::io::{AsyncBufReadExt, BufReader, Lines, Stdin, Stdout, stdin, stdout};
...
mod test {
    ...
    use crate::{
        ...
        simulator::{
            bytes::Bytes,
            sync::{StringMessageReader, parse, read_peer_addresses_from_init},
        },
    };
    use amaru_kernel::cbor;
    use amaru_slot_arithmetic::Slot;
    use pallas_crypto::hash::Hasher;
    use pallas_primitives::{Hash, babbage};
    use proptest::{
