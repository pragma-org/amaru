        ...
        vec![json!(
          {
            ...
            "children": [
              ...
              { "name": "tx_submission.responder.protocol", "target": "amaru_protocols::tx_submission::responder", "message_type": "ReplyTxIds" },
              { "name": "tx_submission.responder.stage", "target": "amaru_protocols::tx_submission::responder", "message_type": "ReplyTxIds" },
              { "name": "validate_header", "target": "amaru_consensus::stages::validate_header" },
              { "name": "fetch_block", "target": "amaru_consensus::stages::fetch_block" },
              { "name": "select_chain", "target": "amaru_consensus::stages::select_chain" },
              { "name": "receive_header", "target": "amaru_consensus::stages::receive_header" },
              { "name": "validate_block", "target": "amaru_consensus::stages::validate_block" },
              ...
              { "name": "tx_submission.responder.protocol", "target": "amaru_protocols::tx_submission::responder", "message_type": "ReplyTxIds" },
              { "name": "tx_submission.responder.stage", "target": "amaru_protocols::tx_submission::responder", "message_type": "ReplyTxIds" },
              { "name": "forward_chain", "target": "amaru_consensus::stages::forward_chain" },
              { "name": "manager", "target": "amaru_protocols::manager", "message_type": "NewTip" },
