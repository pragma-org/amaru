...
use super::{
    BlockSourceEntry, BlockSourceFault, BlockSourceMsg, BlockValidity,
    test_setup::{assert_trace, setup, te_send, test_prep},
};
use crate::stages::test_utils::{te_input, te_state};
...
fn test_block_received_inserts_pending() {
    ...
    expected.by_point.insert(
        p,
        BlockSourceEntry {
            peers: BTreeSet::from([Peer::new("alice")]),
            block_height: BlockHeight::from(50),
            validity: BlockValidity::Pending,
        },
    );
...
fn test_block_received_merges_second_peer() {
    ...
    expected.by_point.insert(
        p,
        BlockSourceEntry {
            peers: BTreeSet::from([Peer::new("alice"), Peer::new("bob")]),
            block_height: BlockHeight::from(50),
            validity: BlockValidity::Pending,
        },
    );
...
fn test_validation_invalid_faults_each_peer() {
    ...
    after_pending_bob.by_point.insert(
        p,
        BlockSourceEntry {
            peers: BTreeSet::from([Peer::new("alice")]),
            block_height: BlockHeight::from(50),
    ...
    final_state.by_point.insert(
        p,
        BlockSourceEntry {
            peers: BTreeSet::from([Peer::new("alice"), Peer::new("bob")]),
            block_height: BlockHeight::from(50),
            validity: BlockValidity::Invalid,
        },
    );
    ...
    assert_trace(
        ...
        &[
            ...
            te_input(BS, &m3),
            te_send(BS, "invalid_sink", BlockSourceFault::InvalidBlock { peer: Peer::new("alice"), point: p }),
            te_send(BS, "invalid_sink", BlockSourceFault::InvalidBlock { peer: Peer::new("bob"), point: p }),
...
fn test_block_received_after_invalid_new_peer_faults() {
    ...
    after_carol.by_point.insert(
        p,
        BlockSourceEntry {
            peers: BTreeSet::from([Peer::new("alice"), Peer::new("carol")]),
            block_height: BlockHeight::from(50),
            validity: BlockValidity::Invalid,
        },
    );
    ...
    assert_trace(
        ...
        &[
            ...
            te_input(BS, &m3),
            te_send(BS, "invalid_sink", BlockSourceFault::InvalidBlock { peer: Peer::new("carol"), point: p }),
