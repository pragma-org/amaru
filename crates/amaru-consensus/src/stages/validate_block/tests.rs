    ...
    assert_trace_contains(
        ...
        &[
            ...
            te_send(
                "vb-1",
                "block_source",
                BlockSourceMsg::Validation { valid: true, point: tip.point(), context: TraceContext::none() },
            )
            .into(),
    ...
    assert_trace_contains(
        ...
        &[
            ...
            te_send(
                "vb-1",
                "block_source",
                BlockSourceMsg::Validation { valid: false, point: tip.point(), context: TraceContext::none() },
            )
            .into(),
        ],
    );
