...
fn test_tip_not_found() {
    ...
    let msg = SelectChainMsg::TipFromUpstream(TipCandidate::new(tip, parent, TraceContext::none()));
...
fn test_tip_extends_from_origin() {
    ...
    assert_trace(
        ...
        &[
            ...
            te_input("sc-1", &msg),
            te_load_header("sc-1", tip.hash(), true),
            te_send("sc-1", "downstream", TipCandidate::new(tip, parent, TraceContext::none())),
...
fn test_block_validation_result_invalid_best_tip_invalidated() {
    ...
    let tip = prep.headers.h2.tip();
    let msg = SelectChainMsg::BlockValidationResult(tip, false, TraceContext::none());
    ...
    assert_trace(
        ...
        &[
            ...
            te_send(
                "sc-1",
                "downstream",
                TipCandidate::new(prep.headers.h1.tip(), prep.headers.h0.point(), TraceContext::none()),
            ),
    ...
    assert_trace(
        ...
        &[
            ...
            te_send(
                "sc-1",
                "downstream",
                TipCandidate::new(prep.headers.h3a.tip(), prep.headers.h2a.point(), TraceContext::none()),
            ),
...
fn test_startup_with_non_empty_store() {
    ...
    let msg = SelectChainMsg::FetchNextFrom(Point::Origin, TraceContext::none());
    ...
    assert_trace(
        ...
        &[
            ...
            te_send(
                "sc-1",
                "downstream",
                TipCandidate::new(prep.headers.h3.tip(), prep.headers.h2.point(), TraceContext::none()),
            ),
            te_state("sc-1", &prep.state),
        ],
    );
...
fn test_fetch_next_from_resumes_best_candidate() {
    ...
    let msg = SelectChainMsg::FetchNextFrom(prep.headers.h1.point(), TraceContext::none());
...
fn test_fetch_next_from_enables_may_fetch_blocks() {
    ...
    let msg = SelectChainMsg::FetchNextFrom(prep.headers.h3.point(), TraceContext::none());
...
fn test_last_best_tip_invalidated_falls_back_to_origin() {
    ...
    let msg = SelectChainMsg::BlockValidationResult(prep.headers.h3.tip(), false, TraceContext::none());
