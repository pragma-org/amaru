    ...
    stages::{
        ...
        track_peers::{
            ...
            test_setup::{
                ...
                setup_with_ledger_tip_until_sleeping, te_clock, te_clock_suspend, te_get_nonces, te_load_header,
                te_load_tip, te_record_header_announcement, te_record_rollback, te_schedule, te_store_validated_header,
...
fn test_roll_forward_known_peer_header_already_stored() {
    ...
    assert_trace_match(
        ...
        &[
            ...
            te_record_header_announcement("tp-1", peer.clone(), header.tip(), header.parent_hash(), received_at).into(),
