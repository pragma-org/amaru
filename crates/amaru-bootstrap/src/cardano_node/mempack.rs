...
fn decode_stake_credential(decoder: &mut Decoder<'_>) -> anyhow::Result<Credential> {
    let tag = decoder.tag()?;
...
fn decode_address28(decoder: &mut Decoder<'_>, stake: Credential) -> anyhow::Result<Address> {
