...
mod tests {
    ...
    #[test_case(fixture!("fail/TreasuryWithdrawalReturnAccountsDoNotExist/0"); "treasury withdrawal to unregistered account")]
    #[test_case(fixture!("fail/TreasuryWithdrawalReturnAccountsDoNotExist/1"); "treasury withdrawal to multiple unregistered accounts")]
    #[test_case(fixture!("fail/TreasuryWithdrawalReturnAccountsDoNotExist/2"); "treasury withdrawal mix of registered and unregistered accounts")]
