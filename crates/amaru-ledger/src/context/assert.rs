...
use amaru_kernel::{
    ...
    CertificatePointer, DRep, Epoch, Lovelace, PoolId, PoolParams, Proposal, ProposalId,
    ProposalPointer, RequiredScript, ScriptPurpose, StakeCredential, TransactionInput,
    TransactionOutput,
};
use core::mem;
