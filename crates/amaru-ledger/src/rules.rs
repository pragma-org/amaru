...
use amaru_kernel::{
    ...
    Hasher, KeepRaw, MintedBlock, MintedTransactionBody, MintedWitnessSet, OriginalHash, Redeemers,
    TransactionInput, TransactionOutput, VKeyWitness,
};
...
use transaction::{
    bootstrap_witness::validate_bootstrap_witnesses,
    disjoint_ref_inputs::disjoint_ref_inputs,
    metadata::{validate_metadata, InvalidTransactionMetadata},
    output_size::validate_output_size,
    vkey_witness::validate_vkey_witnesses,
};
...
mod tests {
    use super::*;
    use crate::rules::context::fake::FakeBlockValidationContext;
    ...
    fn validate_block_success() {
        ...
        let results = validate_block(
            &mut FakeBlockValidationContext::new(),
            bytes.as_slice(),
    ...
    fn validate_block_serialization_err() {
        ...
        assert!(
            validate_block(&mut FakeBlockValidationContext::new(), bytes.as_slice(), pp)
