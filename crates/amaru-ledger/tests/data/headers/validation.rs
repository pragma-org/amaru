...
use amaru_ouroboros_traits::{
    has_pools::{mock_ledger_state::MockLedgerState, GetPoolError}, praos, BlockValidationError,
    HasPools,
    PoolSummary,
};
...
/// `ouroboros-consensus` Haskell code. They carry the generation context, the hex-encoded header
