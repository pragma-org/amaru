...
use crate::{
    CBOR_TAG_MAP_259, DEFAULT_HASH32, Hash, Hasher, MemoizedNativeScript, Metadatum, PlutusScript,
    cbor, heterogeneous_map, key_value_pairs::KeyValuePairs,
};
use serde;

#[derive(Debug, PartialEq, Clone, cbor::Encode, serde::Serialize, serde::Deserialize)]
#[cbor(map)]
...
impl AuxiliaryData {
    ...
    fn decode_alonzo<'b, C>(
        ...
        if d.tag()? != CBOR_TAG_MAP_259 {
            return Err(cbor::decode::Error::tag_mismatch(CBOR_TAG_MAP_259));
        }
