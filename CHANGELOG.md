...
- **amaru-kernel**: transaction witness collections are now sets. Duplicate key witnesses, native scripts, bootstrap witnesses and datums are rejected from protocol version 12 and deduplicated before it, as the Haskell ledger does. Duplicate Plutus scripts are rejected at every version ([#1351](https://github.com/pragma-org/amaru/issues/1351)).
