...
- **amaru-node**: embedders can shut down a running node, wait for its tasks, listeners, and stores to close, and inspect a structured report of component failures before starting another node.
