...
- By receiving this invoice, the scope owner will do a `disburse` and the various proceedings behind the currency of payment specified in the contract will be enacted. The address to be used for the disburse is:
...
- We will try to keep things as simple as they can be while keeping up a structured management environment.
